...
/*Reports*/
        ...
        PermissionSlug::REVENUE_REPORT => [
            'name' => 'revenue-report',
            'description' => 'Download revenue-report',
            'main_menu'=>'reports',
            'sub_menu'=> 'revenue_report',
            'sub_link'=>'reports/revenue',
            'sort' => 16.2,
            'icon' => 'fa fa-circle-thin'
        ],
        PermissionSlug::COMMISSION_REPORT => [
            'name' => 'commission-report',
            'description' => 'Download commission-report',
            'main_menu'=>'reports',
            'sub_menu'=> 'commission_report',
            'sub_link'=>'reports/commission',
            'sort' => 16.2,
            'icon' => 'fa fa-circle-thin'
        ],
        PermissionSlug::STAR_RATINGS_REPORT => [
            'name' => 'star-ratings-report',
            'description' => 'Download star-ratings-report',
            'main_menu'=>'reports',
            'sub_menu'=> 'star_ratings_report',
            'sub_link'=>'reports/star-ratings',
            'sort' => 16.2,
            'icon' => 'fa fa-circle-thin'
        ],
        PermissionSlug::COMPLETED_RIDES_REPORT => [
            'name' => 'completed-rides-report',
            'description' => 'Download completed-rides-report',
            'main_menu'=>'reports',
            'sub_menu'=> 'completed_rides_report',
            'sub_link'=>'reports/completed-rides',
            'sort' => 16.2,
            'icon' => 'fa fa-circle-thin'
        ],
        PermissionSlug::COMPANY_TAG_INTEGRATION_REPORT => [
            'name' => 'company-tag-integration-report',
            'description' => 'Download company-tag-integration-report',
            'main_menu'=>'reports',
            'sub_menu'=> 'company_tag_integration_report',
            'sub_link'=>'reports/company-tag-integration',
            'sort' => 16.2,
            'icon' => 'fa fa-circle-thin'
        ],
        PermissionSlug::AUTO_PDF_REPORT => [
            'name' => 'auto-pdf-report',
            'description' => 'Download auto-pdf-report',
            'main_menu'=>'reports',
            'sub_menu'=> 'auto_pdf_report',
            'sub_link'=>'reports/pdf',
            'sort' => 16.2,
            'icon' => 'fa fa-circle-thin'
        ],
/*geo-fencing*/
