...
// revert_deleted
        ...
        Route::group(['prefix' => 'reports',  'middleware' => 'permission:reports'], function () {
            ...
            Route::post('user/download', 'ReportController@downloadUserReport');

            Route::get('/driver', 'ReportController@driverReport')->name('driverReport');
            Route::post('driver/download', 'ReportController@downloadDriverReport');

            Route::get('/owner', 'ReportController@ownerReport')->name('ownerReport');
            Route::post('owner/download', 'ReportController@downloadOwnerReport');
            ...
            Route::post('travel/download', 'ReportController@downloadTravelReport');
...
/*fetch*/
    ...
    Route::namespace('Master')->group(function () {
        ...
        // Route::get('references/fetch', 'ReferenceController@fetch');
        // References Master CRUD
        Route::group(['prefix' => 'references'], function () {
            Route::get('/', 'ReferenceController@index')->name('references.index');
            Route::get('/fetch', 'ReferenceController@fetch')->name('references.fetch');
            ...
            Route::get('/{reference}', 'ReferenceController@getById')->name('references.show');
            Route::get('edit/{reference}', 'ReferenceController@edit')->name('references.edit');

            Route::put('update/{reference}', 'ReferenceController@update')->name('references.update');
            Route::get('toggle_status/{reference}', 'ReferenceController@toggleStatus')->name('references.toggle_status');
            Route::get('delete/{reference}', 'ReferenceController@delete')->name('references.delete');
        });
