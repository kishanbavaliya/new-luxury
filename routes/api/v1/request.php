...
Route::prefix('request')->namespace('Request')->group(function () {
    Route::get('reminder_customer', 'RequestHistoryController@reminderCustomer');
});
...
//outstation rides
    ...
    Route::middleware(role_middleware([Role::USER,Role::DISPATCHER]))->group(function () {
        ...
        Route::post('update', 'CreateNewRequestController@updateRequest');
    ...
    Route::middleware(role_middleware(Role::DRIVER))->group(function () {
        ...
        Route::post('reminder_90_60/{id}', 'RequestAcceptRejectController@reminder_90_60');
        Route::post('customer_no_show', 'RequestAcceptRejectController@customer_no_show');

        Route::post('driver_no_show', 'RequestAcceptRejectController@driver_no_show');
        // Arrived
    ...
    // Accet/Reject Request
    Route::post('respond_for_owner', 'RequestAcceptRejectController@respond_for_owner');
    Route::post('cancel-by-owner', 'UserCancelRequestController@cancelRequestByOwner');
    // History
