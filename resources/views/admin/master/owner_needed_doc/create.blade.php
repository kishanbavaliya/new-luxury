                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <div class="form-check">
                                                ...
                                                <input class="form-check-input" type="checkbox" name="as_owner" id="as_owner" value="1" {{ old('as_owner') ? 'checked' : '' }}>
                                                <label class="form-check-label" for="as_owner">@lang('view_pages.owner')</label>
                                            </div>
                                            <div class="form-check">
                                                <input type="hidden" name="as_driver" value="0">
                                                <input class="form-check-input" type="checkbox" name="as_driver" id="as_driver" value="1" {{ old('as_driver') ? 'checked' : '' }}>
