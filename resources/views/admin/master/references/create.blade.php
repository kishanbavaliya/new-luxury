                ...
                <div class="col-sm-12">
                    <div class="box">
                        ...
                        <div class="col-sm-12">
                            ...
                            <form method="post" class="form-horizontal" action="{{ route('references.store') }}">
                                @csrf
                                <div class="row">
                                    <div class="col-sm-6">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="short_name">@lang('view_pages.short_name')</label>
                                            <input class="form-control" type="text" id="short_name" name="short_name"
                                                value="{{ old('short_name') }}"
                                                placeholder="@lang('view_pages.enter') @lang('view_pages.short_name')">
