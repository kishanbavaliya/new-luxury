                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="number" id="no_of_people" name="no_of_people" min="0"
                                                value="{{ old('no_of_people') }}" required
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="number" id="no_of_doors" name="no_of_doors" min="0"
                                                value="{{ old('no_of_doors') }}" required
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <select name="transmission" id="transmission" class="form-control" required>
                                                <option value="" selected disabled>@lang('view_pages.select')</option>
                                                <option value="manual" {{ old('transmission') == 'manual' ? 'selected' : '' }}>@lang('view_pages.manual')</option>
                                                <option value="automatic" {{ old('transmission') == 'automatic' ? 'selected' : '' }}>@lang('view_pages.automatic')</option>
                                            </select>
