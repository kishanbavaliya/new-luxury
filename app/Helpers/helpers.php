...
if (!function_exists('filter')) {
     ...
     */
    function filter(Builder $builder = null, $transformer = null, FilterContract $customFilter = null, $history = NULL)
    {
...
if (! function_exists('get_directions')) {
    ...
    if (!function_exists('luxury_limoexpress_owner_id')) {
        function luxury_limoexpress_owner_id()
        {
            $Owner = Owner::where("email", "multani@luxury-limoexpress.com")->first();

            if(empty($Owner)){
                $Owner = Owner::where("company_name", "Luxury Limoexpress")->first();
            }
