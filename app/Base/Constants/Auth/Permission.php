...
/*Reports*/
    ...
    const REVENUE_REPORT = 'revenue-report';
    const COMMISSION_REPORT = 'commission-report';
    const STAR_RATINGS_REPORT = 'star-ratings-report';
    const COMPLETED_RIDES_REPORT = 'completed-rides-report';
    const COMPANY_TAG_INTEGRATION_REPORT = 'company-tag-integration-report';
    const AUTO_PDF_REPORT = 'auto-pdf-report';
